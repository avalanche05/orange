...
from openapi_client.models.limit_price_bid_req import LimitPriceBidReq  # noqa: E501
from openapi_client.rest import ApiException

class TestLimitPriceBidReq(unittest.TestCase):
    """LimitPriceBidReq unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test LimitPriceBidReq
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.limit_price_bid_req.LimitPriceBidReq()  # noqa: E501
        if include_optional :
            return LimitPriceBidReq(
                symbol_id = 2, 
                price = 100, 
                quantity = 1
            )
