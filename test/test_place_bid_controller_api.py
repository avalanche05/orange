...
from openapi_client.api.place_bid_controller_api import PlaceBidControllerApi  # noqa: E501
from openapi_client.rest import ApiException


class TestPlaceBidControllerApi(unittest.TestCase):
    """PlaceBidControllerApi unit test stubs"""

    def setUp(self):
        self.api = openapi_client.api.place_bid_controller_api.PlaceBidControllerApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_place_best_price_buy_bid(self):
        """Test case for place_best_price_buy_bid

        Размещает заявку на покупку по 'лучшей цене'  # noqa: E501
        """
        pass

    def test_place_best_price_sell_bid(self):
        """Test case for place_best_price_sell_bid

        Размещает заявку на продажу по 'лучшей цене'  # noqa: E501
        """
        pass

    def test_place_limit_price_buy_bid(self):
        """Test case for place_limit_price_buy_bid

        Размещает заявку на покупку по цене не более установленной  # noqa: E501
        """
        pass

    def test_place_limit_price_sell_bid(self):
        """Test case for place_limit_price_sell_bid
