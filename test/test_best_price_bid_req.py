...
from openapi_client.models.best_price_bid_req import BestPriceBidReq  # noqa: E501
from openapi_client.rest import ApiException

class TestBestPriceBidReq(unittest.TestCase):
    """BestPriceBidReq unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test BestPriceBidReq
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.best_price_bid_req.BestPriceBidReq()  # noqa: E501
        if include_optional :
            return BestPriceBidReq(
                symbol_id = 2, 
                quantity = 100
            )
        else :
