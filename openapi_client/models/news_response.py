...
class NewsResponse(object):
    ...
    def __init__(self, date=None, text=None, rate=None, companies_affected=None, local_vars_configuration=None):  # noqa: E501
        """NewsResponse - a model defined in OpenAPI"""  # noqa: E501
        ...
        if rate is not None:
            self.rate = rate
        if companies_affected is not None:
            self.companies_affected = companies_affected

    @property
    def date(self):
        """Gets the date of this NewsResponse.  # noqa: E501

        Дата-время новости  # noqa: E501

        :return: The date of this NewsResponse.  # noqa: E501
        :rtype: datetime
        """
        return self._date
    ...
    @date.setter
    def date(self, date):
        """Sets the date of this NewsResponse.

        Дата-время новости  # noqa: E501

        :param date: The date of this NewsResponse.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def text(self):
        """Gets the text of this NewsResponse.  # noqa: E501

        Текст новости  # noqa: E501

        :return: The text of this NewsResponse.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this NewsResponse.

        Текст новости  # noqa: E501

        :param text: The text of this NewsResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def rate(self):
        """Gets the rate of this NewsResponse.  # noqa: E501

        Предполагаемое влияние  # noqa: E501

        :return: The rate of this NewsResponse.  # noqa: E501
        :rtype: int
        """
        return self._rate
    ...
    @rate.setter
    def rate(self, rate):
        """Sets the rate of this NewsResponse.

        Предполагаемое влияние  # noqa: E501

        :param rate: The rate of this NewsResponse.  # noqa: E501
        :type: int
        """
    ...
    @property
    def companies_affected(self):
        """Gets the companies_affected of this NewsResponse.  # noqa: E501

        Список затронутых компаний  # noqa: E501

        :return: The companies_affected of this NewsResponse.  # noqa: E501
        :rtype: list[str]
        """
        return self._companies_affected

    @companies_affected.setter
    def companies_affected(self, companies_affected):
        """Sets the companies_affected of this NewsResponse.

        Список затронутых компаний  # noqa: E501

        :param companies_affected: The companies_affected of this NewsResponse.  # noqa: E501
        :type: list[str]
        """

        self._companies_affected = companies_affected
