...
class StockInfoApi(object):
    ...
    def get_buy_stock_by_symbol_id(self, token, **kwargs):  # noqa: E501
        """Заявки на покупку  # noqa: E501

        Возвращает количество активных заявок и их цену  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_buy_stock_by_symbol_id(token, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str token: Токен доступа (required)
        ...
        :return: list[StockResp]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.get_buy_stock_by_symbol_id_with_http_info(token, **kwargs)  # noqa: E501

    def get_buy_stock_by_symbol_id_with_http_info(self, token, **kwargs):  # noqa: E501
        """Заявки на покупку  # noqa: E501

        Возвращает количество активных заявок и их цену  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_buy_stock_by_symbol_id_with_http_info(token, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[StockResp], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_buy_stock_by_symbol_id" % key
                )
        ...
        if self.api_client.client_side_validation and ('token' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `token` when calling `get_buy_stock_by_symbol_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='list[StockResp]',  # noqa: E501
    ...
    def get_sell_stock_by_symbol_id(self, token, **kwargs):  # noqa: E501
        """Заявки на продажу  # noqa: E501

        Возвращает количество активных заявок и их цену  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_sell_stock_by_symbol_id(token, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_sell_stock_by_symbol_id_with_http_info(token, **kwargs)  # noqa: E501

    def get_sell_stock_by_symbol_id_with_http_info(self, token, **kwargs):  # noqa: E501
        """Заявки на продажу  # noqa: E501

        Возвращает количество активных заявок и их цену  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_sell_stock_by_symbol_id_with_http_info(token, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_sell_stock_by_symbol_id" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'token' is set
        if self.api_client.client_side_validation and ('token' not in local_var_params or  # noqa: E501
                                                        local_var_params['token'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `token` when calling `get_sell_stock_by_symbol_id`")  # noqa: E501
    ...
    def getsymbols(self, token, **kwargs):  # noqa: E501
        """Список всех активов  # noqa: E501

        Возвращает список всех возможных активов  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.getsymbols(token, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: list[SymbolsResp]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.getsymbols_with_http_info(token, **kwargs)  # noqa: E501

    def getsymbols_with_http_info(self, token, **kwargs):  # noqa: E501
        """Список всех активов  # noqa: E501

        Возвращает список всех возможных активов  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.getsymbols_with_http_info(token, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[SymbolsResp], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('token' not in local_var_params or  # noqa: E501
                                                        local_var_params['token'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `token` when calling `getsymbols`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[SymbolsResp]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
